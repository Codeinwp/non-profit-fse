...
<figure class="wp-block-image size-full has-custom-border" style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px"><img src="https://nonprofit.instawp.xyz/wp-content/uploads/2025/02/non-profit-05.webp" alt="" class="wp-image-210" style="border-left-color:var(--wp--preset--color--ti-accent-secondary);border-left-width:16px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->

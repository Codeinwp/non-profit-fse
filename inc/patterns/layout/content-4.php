...
<figure class="wp-block-image size-full has-custom-border"><img src="https://nonprofit.instawp.xyz/wp-content/uploads/2025/02/non-profit-03.webp" alt="" class="wp-image-208" style="border-right-color:var(--wp--preset--color--ti-accent);border-right-width:16px;aspect-ratio:1;object-fit:cover"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->

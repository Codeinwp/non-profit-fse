# Agent Guide — Non Profit FSE

## Overview

Non Profit FSE is a block-based WordPress theme built for Full Site Editing. PHP theme code lives in the `NonProfitFSE` namespace under `inc/`; the theme also provides block patterns, templates, template parts, styles, and JavaScript and SCSS assets.
...
The project uses PHP 7.2 and Node.js 16.
...
- Put PHP theme behavior in the existing `NonProfitFSE` namespace and preserve the current class structure.
